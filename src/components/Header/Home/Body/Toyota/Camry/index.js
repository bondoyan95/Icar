...
const carImageUrl =
  'https://agungtoyotabatam.com/wp-content/uploads/2023/04/04_graphite-metallic.png';
  ...
  return (
    <div style={styles.toyotaCorolla}>
      <div style={styles.contentWrapper}>
        <h2 style={styles.title}>Toyota Camry: Reliable and Popular Car</h2>
        <div style={styles.content}>
          <p>
            Toyota Camry is one of the most popular and long-lasting cars in the world. This compact sedan or hatchback (or crossover in some versions) is known for its reliability, fuel efficiency, and comfort.
          </p>
