...
const carImageUrl =
'https://www.buyatoyota.com/assets/img/vehicle-info/Highlander/2023/hero_image_highlander.png';
  ...
  return (
    <div style={styles.toyotaCorolla}>
      <div style={styles.contentWrapper}>
        <h2 style={styles.title}>Toyota Highlander: Reliable and Popular Car</h2>
        <div style={styles.content}>
          <p>
            Toyota Highlander is one of the most popular and long-lasting cars in the world. This compact sedan or hatchback (or crossover in some versions) is known for its reliability, fuel efficiency, and comfort.
          </p>
