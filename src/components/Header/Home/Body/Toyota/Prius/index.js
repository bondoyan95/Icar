...
const carImageUrl =
  'https://www.motortrend.com/uploads/sites/10/2015/11/2015-toyota-prius-hybrid-three-hatchback-angular-front.png?fit=around%7C875:492.1875';
  ...
  return (
    <div style={styles.toyotaCorolla}>
      <div style={styles.contentWrapper}>
        <h2 style={styles.title}>Toyota Prius: Reliable and Popular Car</h2>
        <div style={styles.content}>
          <p>
            Toyota Prius is one of the most popular and long-lasting cars in the world. This compact sedan or hatchback (or crossover in some versions) is known for its reliability, fuel efficiency, and comfort.
          </p>
